...
const Hero = () => {
  ...
  return (
      <motion.div
          className="bg-indigo-200/50 dark:bg-slate-950 flex flex-col items-center py-16 bg md:h-screen px-"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          ...
          id="home"
      >
          <div className="flex flex-col items-center justify-center lg:flex-row relative top-0 w-full h-auto lg:w-auto pb-10">
              <div id="left" className="lg:w-3/5">
                  ...
                  >
                      ...
                      >
                          Hi I'm{' '}
                          <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-700 to-cyan-500 ml-2 font-OpenSans">
                              Ali Murtaza
                          </span>
                      </motion.h1>
                      <motion.p
              ...
              <div id="right" className="z-10 lg:w-2/5 mt-10 lg:mt-0">
                  ...
                  >
                      <img
                          src={theme === 'light' ? './mainIcons.svg' : './mainIconsdark.svg'}
                          alt="img"
